...
function botonWhatsAppClicked(event, productos) {
  ...
  window.open(
    "https://api.whatsapp.com/send?phone=++5491158102407&text=Hola,%20quiero%20comprar%20el%20producto%20*" + productoAgregado.titulo + "*,%20que%20tiene%20un%20precio%20de%20*$" + productoAgregado.precio.toFixed(2) + "*.%20Muchas%20gracias!",
    "_blank"
  )
